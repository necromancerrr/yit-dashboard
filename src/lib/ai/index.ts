 ...
 * site — nothing outside this folder should import a vendor SDK. Adding
 * DeepSeek or another vendor means adding a class that satisfies AIProvider
 * and a case here; no feature code changes.
 *
